...
class Config:
    ...
    def _load_environment_variables(self) -> None:
        ...
        if data_dir:
            ...
            self._config['paths']['database_file'] = os.path.join(data_dir, 'database', 'oevk.db')
        ...
        if include_partitioned:
            self._config['export']['include_partitioned_addresses'] = include_partitioned.lower() == 'true'
        
        include_consolidated = os.getenv('INCLUDE_CONSOLIDATED_ADDRESSES')
        if include_consolidated:
            self._config['export']['include_consolidated_addresses'] = include_consolidated.lower() == 'true'
